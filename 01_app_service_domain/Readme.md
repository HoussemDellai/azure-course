# Azure App Service Domain Names

## Introduction

`Azure App Service Domains` are custom domains that are managed directly in Azure. They make it easy to manage custom domains for Azure services like:
- App Service
- Container Apps
- Traffic Manager
- VM
